...
${detail_product_locator.txt_name_product}            css=h1:text-is("***product_name***")
# ${detail_product_locator.txt_total_price}             css=span:text-is("Total (incl. VAT)") + span:has-text("THB")
${detail_product_locator.txt_total_price}             css=span:text-is("${translation.txt_detail_total}") + span:has-text("${translation.txt_detail_currency}")